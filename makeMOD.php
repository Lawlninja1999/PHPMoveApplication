...
while ($row = $HO->fetch_assoc())
	if(''.$row['AccessLevel'].'' !== 'Admin')
	{
		...
		else
		{
			...
			YearOfBirth = '".$yearOfBirth."', Country = '".$country."',Password = '".$password."',AccessLevel = 'Moderator'
...
<form name="editMemberForm" method="post">
  <table style="width: 500px; border: 0px;" cellspacing="1" cellpadding="1">
    ...
    <tr style="background-color: #FFFFFF;"> 
      <td> 
		<input type="submit" name="submit" value="Make <?php echo $row['Username'];?> An Moderator" />
      <td> 
